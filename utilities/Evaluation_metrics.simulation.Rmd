...
- All the simulated transcripts.
- All the transcripts simulated with at least 1 TPM expression.
- All the transcripts simulated with at least 5 TPM expression.
- Only those transcripts that were added from a different organism (evaluation of novelty).
...
**False Positive** metrics are mainly relevant when using as ground truth the entire set of simulated transcripts.

**ATENTION**
If in this chunk of the evaluation all the results are 0, please, check if the reference genome and/or transcriptome.

### Evaluation of all simulation
...
### Evaluation of all simulation with TPM >= 1
...
### Evaluation of all simulation with TPM >= 5
